#znad {
    ...
    background-image: linear-gradient(90deg,#d65463b8 0,#d65463de 10%,#d65463 51%,#d65463e0 89%,#d65463b8 100%);
...
#des4,label.label.label-primary.mini.fl {
    ...
    background-image: linear-gradient(90deg,#d86292 0,#ca497e 10%,#b72e66 51%,#ca497e 89%,#d86292 100%)
